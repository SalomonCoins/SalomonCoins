...
def add_transaction():
    ...
    transacion_keys = ['sender', 'recevier','amount']
...
#descentralizadoel blockchain

#conectado nuevo nodos
...
def connect_node():
    ...
    response = {'message': 'Todos los nodos estan ahora conectados. el pegacoins Blockchain contiene los siguientes nodos:',
...
def replace_chain():    
    ...
    if is_valid_replaced:
        response = {'message':'fue actualizado lo mas reciente',
